            ...
            if (jsonObject.containsKey("username") && jsonObject.containsKey("username") &&
                ...
                if (user != null) {
                    ...
                    if (verifySession) {
                        ...
                        response.append("{ \"error\" : \"Failure: Can not create session\" }");
                    }
                } else {
                    response.append("{ \"error\" : \"Failure: Wrong username or password\" }");
                }

            } else {
                response.append("{ \"error\" : \"Failure: Incorrect parameters\" }");
            }
